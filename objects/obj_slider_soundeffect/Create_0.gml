...
{
draw_self();
draw_text_color(x + 40, y - 40, "Efeitos sonoros", c_silver, c_silver, c_silver, c_silver, 1)
draw_text_color(x + 90, y + 25, "Janela", c_silver, c_silver, c_silver, c_silver, 1)
